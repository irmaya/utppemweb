 ...
 <li>
        ...
        <div id="page-wrapper" class="page-wrapper-cls">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Edit Pinjaman </h1>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
...
<form class="form-horizontal" action="updated.php" enctype="multipart/form-data" method="post">    
<?php
include('dbcon.php');
...
for($i=0; $i < $N; $i++)
{
	$result = mysql_query("SELECT * FROM pinjaman where nom='$id[$i]'");
    ...
    <input name="npm[]" type="hidden" value="<?php echo  $row['npm'] ?>" />
    <input name="peminjam[]" type="hidden" value="<?php echo  $row['peminjam'] ?>" />
    <input name="kodebuku[]" type="hidden" value="<?php echo  $row['kodebuku'] ?>" />
    <input name="judul[]" type="hidden" value="<?php echo  $row['judul'] ?>" />
    <input name="pengarang[]" type="hidden" value="<?php echo  $row['pengarang'] ?>" />
    <input name="kategori[]" type="hidden" value="<?php echo  $row['kategori'] ?>" />
    <input name="tgl_pinjam[]" id="tglku" type="text" value="<?php echo  $row['tgl_pinjam'] ?>" />
    <input name="tgl_kembali[]" id="tglku2" type="text" value="<?php echo  $row['tgl_kembali'] ?>" />
    <br>
     <label class="control-label" for="inputEmail">Denda Rp.</label>
    <input name="denda[]" type="text" value="<?php echo  $row['denda'] ?>" class="form-control" />
        <label class="control-label" for="inputEmail">Status Buku : ex: buku ini dikembalikan tanpa denda</label>

		<input name="status[]" type="text" value="<?php echo $row['status'] ?>" class="form-control" required />
    </div>
			 <br> 
	  <?php 
	  }
