 ...
 <li>
        ...
        <div id="page-wrapper" class="page-wrapper-cls">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Profil User </h1>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
...
<form action="<?php echo $editFormAction; ?>" name="updatme" method="POST" enctype="multipart/form-data" id="updatme">    
    ...
    <div class="controls">
    <input name="id" type="hidden" value="<?php echo $row_coduser['id']; ?>" class="form-control"/>
		<input name="nama" type="text" value="<?php echo $row_coduser['nama']; ?>" class="form-control"/>
    </div>
    </div>
	...
	<div class="control-group">
    <label class="control-label" for="inputEmail">Photo (silahkan upload ulang untuk update!)</label>
    <div class="controls">
