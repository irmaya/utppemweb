 ...
 <li>
        ...
        <div id="page-wrapper" class="page-wrapper-cls">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Input Buku</h1>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
...
<form action="addbuk.php" method="post" enctype="multipart/form-data">
...
<select name="nim" class="form-control" id="nim" onChange="changeValue(this.value)">
    ...
    while ($row = mysql_fetch_array($query_run)) {    
        echo '<option value="' . $row['jenisb'] . '">' . $row['jenisb'] . '</option>';    
        $jsArray .= "dtMhs['" . $row['jenisb'] . "'] = {nama:'" . addslashes($row['jenisb']) . 
		"',jrsn:'".addslashes($row['kodeb'])."' };\n";    
    }      
?>
	...
	document.getElementById('jrsn').value = dtMhs[nim].jrsn;
		...
		<input name="kode" type="text" class="form-control" id="jrsn" required/>


    <label class="control-label" for="inputEmail">Kelompok Buku</label>
		<input name="kelompok" type="text" class="form-control" id="nm"/>
    ...
    <label class="control-label" for="inputEmail">Penerbit</label>
		<input name="penerbit" type="text" class="form-control"/>
            ...
            <label class="control-label" for="inputEmail">Cover Buku (max 2mb)</label>
		<input name="gambar" type="file" />

            <label class="control-label" for="inputEmail">Tanggal Masuk</label>
	<input name="tgl_masuk" type="text" class="form-control" id="tglku"/>
    
            <label class="control-label" for="inputEmail">Stock Buku / jumlah</label>
	<input name="sedia" type="text" class="form-control"/>
                
        
<br>
 <input type="submit" name="button" id="btn-savec" value="+ Tambah" class="btn btn-success"></form>
<div id="dis">
</div>       
